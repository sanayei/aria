...
FILE_CATEGORIES = {
    ...
    "audio": {"mp3", "wav", "flac", "aac", "ogg", "m4a", "wma", "opus", "ape", "alac", "aiff"},
    "code": {
        "py",
        "js",
        "ts",
    ...
    "archive": {"zip", "tar", "gz", "bz2", "xz", "rar", "7z", "tgz", "tbz2", "iso", "dmg", "pkg"},
    "executable": {"exe", "msi", "app", "bat", "cmd", "com", "bin", "deb", "rpm", "apk", "jar"},
}
